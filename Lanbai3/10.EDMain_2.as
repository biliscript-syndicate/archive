...
Composition({
		  ...
		  duration : 250000,
			...
			{
			  //106679 - 136000 - 191250
			  provider : singleStaffComp(84400 , 90200 ,true, PhotoComp(true, ED.PhotoLayerArray[6]),680,"蓝白ED：\n《福笑い》\n弹幕：麦子、面汤拌菜菌\n素材画师：\n鱼火锅、Meltdown_") ,
			  inPoint : 84400,
			  outPoint : 90200
			}),
			/*DynamicSourceLayer(
			...
			outPoint : 96500,
			 properties :
			 {
				 ...
				 alpha : KeyframesBind(
			  {
				keyframes :
				[
				  Keyframe({ time : 90200 , value : 0, interpolation : Interpolation.linear }),
				  Keyframe({ time :  90200+300, value : 1, interpolation : Interpolation.linear }),
				  Keyframe({ time : (96500 - 400), value : 1, interpolation : Interpolation.linear }),
				  Keyframe({ time : 96500, value : 0, interpolation : Interpolation.linear })
				  ]
				}),
			  y : KeyframesBind(
			  {
				keyframes :
				[
				  Keyframe({ time : 90200, value : 380, interpolation : Interpolation.linear }),
				  Keyframe({ time : (96500 - 400), value : 360, interpolation : Interpolation.cubic.easeIn }),
				  Keyframe({ time : 96500, value : 350, interpolation : Interpolation.cubic.easeOut })
				  ]
				}),
			  "transform.colorTransform" : Color.rgbToTransformTint( [ 1, 0, 0, 0 ] ),
			...
			outPoint : 101500,
			 properties :
			 {
				 ...
				 alpha : KeyframesBind(
			  {
				...
				[
				  Keyframe({ time : 96500 , value : 0, interpolation : Interpolation.linear }),
				  Keyframe({ time :  96500+300, value : 1, interpolation : Interpolation.linear }),
			  ...
			  y : KeyframesBind(
			  {
				keyframes :
				[
				  Keyframe({ time : 96500, value : 380, interpolation : Interpolation.linear }),
	...
	DynamicVectorTextLayer({
			 ...
			 textProperties : 
			{
			  ...
			  lineHeight : 55,
			  fontSize : 40,
			  text :"ED协力：奇迹の海\n协力：ABZ  初音の消失  Dreamon  Devl \n大吃货焦糖桑  河童子  静之籁  沁沁 \nStar寒雨  XiaoLLK  小包子  妖刀罪歌 \n特别感谢：时空游客  ⑨Bishi 云雀Nic"
			}
			})
		 	]
